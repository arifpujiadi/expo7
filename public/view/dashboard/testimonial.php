...
<html lang="en">
    <head>
        ...
        <link href="../../css/download/starrr.css" rel="stylesheet">
        <link href="../../css/custom/dashboard/testimonial.css" rel="stylesheet">
    </head>
    ...
    <body class="nav-sm">
                                    ...
                                    <div class="boxOut-contentLeft inherit">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <button type="button" class="btn button-send font-RobotoCondensed-Bold" onclick='window.location.assign("redirectPage.php")'>Send Testimonial</button>
                                            </div>
                                        </div>
                                    </div>
        ...
        <script src="../../js/download/starrr.js"></script>
        <script>
