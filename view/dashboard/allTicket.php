...
<html lang="en">
    <head>
        ...
        <link href="../../css/custom/dashboard/allTicket.css" rel="stylesheet">
    </head>
                                                    ...
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        <div class="col-md-2 col-sm-3 col-xs-3">
                                                            <div class="boxOut-foto-img">
                                                                <img src="../../img/icon/message-null.png">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-10 col-sm-9 col-xs-9 boxOut-borderMessage">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 col-xs-12 status-message font-Roboboto status-answered">
                                                                    Answered
                                                                </div>
                                            ...
                                            <li>
                                                <a href="#message-2" data-toggle="tab">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-md-10 col-sm-9 col-xs-9 boxOut-borderMessage">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 col-xs-12 status-message font-Roboboto status-inProgres">
                                                                    In Progress
                                                                </div>
                                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageTitle font-Roboboto-Bold">
                                                                    <div class="name-sales">
                                            ...
                                            <li>
                                                <a href="#message-3" data-toggle="tab">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-md-10 col-sm-9 col-xs-9 boxOut-borderMessage">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 col-xs-12 status-message font-Roboboto status-solved">
                                                                    Solved
                                                                </div>
                                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageTitle font-Roboboto-Bold">
                                                                    <div class="name-sales">
                                            ...
                                            <li>
                                                <a href="#message-4" data-toggle="tab">
                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        <div class="col-md-10 col-sm-9 col-xs-9 boxOut-borderMessage">
                                                            <div class="row">
                                                                <div class="col-md-12 col-sm-12 col-xs-12 status-message font-Roboboto status-waitingOnMember">
                                                                    Waiting on Member
                                                                </div>
                                                                <div class="col-md-12 col-sm-12 col-xs-12 boxOut-messageTitle font-Roboboto-Bold">
                                                                    <div class="name-sales">
                                    ...
                                    <div class="inherit box-content-right">
                                        ...
                                        <div class="inherit tab-content">
                                            ...
                                            <div class="inherit tab-pane mCustomScrollbar" data-mcs-theme="dark-3" id="message-1">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 col-sm-12 col-xs-12 boxOut-background-ganjil">
                                                        <div class="x_panel">
                                                            <div class="x_content">
                                                                <div class="row">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                                                        ...
                                                                        <button type="button" class="btn button-save font-RobotoCondensed">If resolve, click here to close the ticket</button>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
